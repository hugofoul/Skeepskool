export const fr = {
  ...
  home: {
    ...
    offers: {
      ...
      cards: [
        ...
        {
          featuredLabel: '★ LE PLUS ADAPTÉ À UN ENSEIGNEMENT DE QUALITÉ',
          title: 'Stage 10 séances',
          subtitle: '10 séances · 20 h',
          description: 'La formule la plus adaptée pour un enseignement de qualité et une progression durable.',
          pricePrefix: 'À partir de',
          cta: 'Réserver',
          packageValue: 'pack10',
        },
    ...
    testimonials: [
      {
        name: 'Camille D.',
        text: "Première session de surf en famille, accueil au top et moniteur super pédagogue. Mes enfants ont adoré, on reviendra cet été !",
      },
      {
        name: 'Julien M.',
        text: "Spot magnifique entre dune et forêt. En deux cours j'étais debout sur la planche. Matériel nickel et ambiance géniale.",
      },
      {
        name: 'Sarah L.',
        text: "Le pack 5 cours est parfait pour progresser vraiment. Équipe passionnée et bienveillante, je recommande à 100 %.",
      },
    ],
  },
  ...
  school: {
    ...
    team: [
      ...
      {
        name: 'Hugo',
        role: 'Le gardien de la cabane',
        image: 'hugo',
        text: 'Le gardien de la cabane ! Toujours là pour le matériel, l’accueil et la bonne ambiance.',
      },
      {
        name: 'Oscar',
        role: 'Le prof',
