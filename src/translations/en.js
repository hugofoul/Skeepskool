  ...
  home: {
    ...
    offers: {
      ...
      cards: [
        ...
        {
          featuredLabel: '★ BEST FOR HIGH-QUALITY COACHING',
          title: '10-lesson pack',
          subtitle: '10 sessions · 20 h',
          description: 'The most suitable package for high-quality coaching and long-term progress.',
          pricePrefix: 'From',
          cta: 'Book now',
          packageValue: 'pack10',
        },
    ...
    testimonials: [
      {
        name: 'Camille D.',
        text: 'First family surf session — warm welcome and a great teaching instructor. My kids loved it, we will be back this summer!',
      },
      {
        name: 'Julien M.',
        text: 'Beautiful spot between dune and forest. After two lessons I was standing on the board. Gear in perfect shape and great vibe.',
      },
      {
        name: 'Sarah L.',
        text: 'The 5-lesson pack is perfect to really progress. Passionate and caring team — I recommend it 100%.',
      },
    ],
  },
