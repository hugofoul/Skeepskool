...
export default function WhatsAppWidget() {
  ...
  return (
    <a
      ...
      className={`fixed top-6 right-6 z-40 flex items-center gap-3 rounded-full bg-green-500 px-4 py-3 text-white shadow-lg hover:bg-green-600 transition-all duration-300 hover:scale-110 ${
